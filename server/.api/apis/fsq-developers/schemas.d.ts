        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly radius: {
                    ...
                    readonly maximum: 2147483647;
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Defines the distance (in meters) within which to return place results. Setting a radius biases the results to the indicated area, but may not fully restrict results to that specified area.";
                };
                readonly types: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly radius: {
                    ...
                    readonly format: "int32";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Sets a radius distance (in meters) used to define an area to bias search results. The maximum allowed radius is 100,000 meters. Radius can be used in combination with ll or ip biased geolocation only. By using radius, global search results will be omitted.";
                };
                readonly categories: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                ...
                readonly exclude_chains: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Filters the response and returns FSQ Places not matching any of the specified chains. Supports multiple chain IDs, separated by commas.\n\nFor more information on Foursquare Chain IDs, refer to the <a href=\"https://docs.foursquare.com/docs/chains\" target=\"blank\">Chains</a> page.";
                };
                readonly exclude_all_chains: {
                    readonly type: "boolean";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Filters the response by only returning FSQ Places that are not known to be part of any chain.";
                };
                readonly fields: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                ...
                readonly polygon: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "A string containing the list of coordinates which define the edges of the polygon. Must have at least 4 coordinates and be considered a \"closed\" polygon.";
                };
                readonly sort: {
                    readonly type: "string";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly fields: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Indicate which fields to return in the response, separated by commas. Supported fields are:<ul><li> id - the ID of the tip</li><li> created_at - when was the tip created</li><li> text - what does the tip actually say?</li><li> lang - what language was the tip created in</li></ul>Default fields if this param is omitted are \"id\", \"created_at\", and \"text\".";
                };
                readonly sort: {
                    readonly type: "string";
                    readonly enum: readonly ["POPULAR", "NEWEST"];
